...
| **5** | *"Midnight Explorer links in README and UI were pointing to an older route structure."* | Explorer URL format evolved in recent Midnight releases to standard `/contracts/<hex>` path. | Standardized all Midnight Explorer links to `https://preprod.midnightexplorer.com/contracts/020023cb08948a7c9cea4da3ecc1f1a96da9fba105c9f0f9583232da6db18934d586`. | [`README.md`](file:///README.md)<br>[`contracts/deployment.json`](file:///contracts/deployment.json) | [`2cc778e`](https://github.com/missingmoonlight/veilpass/commit/2cc778e)<br>[`1aa855d`](https://github.com/missingmoonlight/veilpass/commit/1aa855d) |
...
1. **Launch Cohort Onboarding (`LAUNCH_USERS.md`)**:
   - Onboarded 20 launch cohort users testing the live deployed Preprod contract (`020023cb08948a7c9cea4da3ecc1f1a96da9fba105c9f0f9583232da6db18934d586`).
